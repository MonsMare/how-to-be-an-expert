/* ====================================================================
 * how-to-be-an-expert · 结构化数据集（v3）
 * 数据源已扩展：43 位非中国专家 + 15 位中国专家 = 58 位中外专家。
 * 每条观点新增真实性核验：auth = 亲历 / 借鉴 / 共识；verify = 判定依据。
 * 每位专家含国别双字段：countryBirth（出生国）/ countryWork（主要执业国）。
...
const EXPERTS = [
  ...
  {
    id:"xiaolai", name:"Li Xiaolai", nameZh:"李笑来",
    file:"experts/李笑来.md",
    gender:"男", birth:1972, died:null, age:54, ageBracket:"50-64",
    field:"思想写作与传播", income:"千万至亿级（波动大）", incomeTier:4, region:"中国",
    bio:"前新东方教师、畅销书作家、比特币早期投资者与知识付费先行者，《把时间当作朋友》作者。",
    schools:["strategy","action"],
    viewpoints:[
      {t:"成长优于成功", c:["C15","C7"], d:"成功对具体人而言，成长对每个人而言——聚焦可掌控的过程。", auth:"亲历", verify:"其《把时间当作朋友》核心命题"},
      {t:"时间不可管理，管理自己", c:["C2","C15"], d:"能管理的只有自己：注意力、方向与行动质量。", auth:"亲历", verify:"其《把时间当作朋友》核心命题"},
      {t:"心智是底层差异", c:["C6","C7"], d:"人与人的根本差异在看待世界的底层系统，心智开启是漫长过程。", auth:"亲历", verify:"其《把时间当作朋友》心智章节（大意）"},
      {t:"一切学习靠积累", c:["C2","C1"], d:"速成是幻觉，精通依赖长期持续刻意的练习。", auth:"亲历", verify:"其著作与博客（大意）"},
      {t:"注意力是最稀缺资源", c:["C3","C14"], d:"注意力>时间>金钱：投向哪里决定产出在哪里。", auth:"亲历", verify:"其《通往财富自由之路》专栏（大意）"},
      {t:"行动闭环知识", c:["C16","C1"], d:"知道没有力量，相信并做到才有力量。", auth:"亲历", verify:"其博客与公开演讲（大意）"},
      {t:"升级个人商业模式", c:["C14","C9"], d:"从卖一份时间到把同一份时间卖出多次，专业价值可复制规模化。", auth:"亲历", verify:"其《财富自由之路》（大意）"},
    ]
  },
  {
    id:"wujun", name:"Wu Jun", nameZh:"吴军",
    file:"experts/吴军.md",
    gender:"男", birth:1967, died:null, age:59, ageBracket:"50-64",
    field:"计算机与工程科技", income:"十万至百万美元级（30–100万美元）", incomeTier:2, region:"中国",
    bio:"计算机科学家、硅谷投资人、《浪潮之巅》《数学之美》《见识》作者，前Google资深研究员、腾讯副总裁。",
    schools:["thinking","practice","strategy"],
    viewpoints:[
      {t:"见识决定命运", c:["C9","C2"], d:"根本差异不在智力与勤奋而在见识——格局与做事方法。", auth:"亲历", verify:"其《见识》核心论点"},
      {t:"做减法优先于加法", c:["C14","C9"], d:"聚焦少数高杠杆复利之事，拒绝低价值活动。", auth:"亲历", verify:"其《见识》核心论点"},
      {t:"复利式投入", c:["C2","C1"], d:"读书、锻炼、核心技能训练短期无差、长期拉开数量级。", auth:"亲历", verify:"其《见识》《态度》论述"},
      {t:"底层能力大于表面技巧", c:["C6","C1"], d:"数学、逻辑、写作长期有效，表层技巧几年过时。", auth:"亲历", verify:"其《数学之美》及访谈（大意）"},
      {t:"方向比努力重要", c:["C9","C2"], d:"选对赛道并长期坚持，比盲目努力重要得多。", auth:"亲历", verify:"其《格局》论述（大意）"},
      {t:"工程师五级论", c:["C1","C5"], d:"最高级为能开创产业之人，级差是数量级而非线性。", auth:"亲历", verify:"其《硅谷来信》专栏（大意）"},
      {t:"阅读是提升见识的第一路径", c:["C11","C6"], d:"阅读突破个人经验局限，获取人类智慧最高效方式。", auth:"亲历", verify:"其《见识》论述（大意）"},
    ]
  },
  {
    id:"duanyongping", name:"Duan Yongping", nameZh:"段永平",
    file:"experts/段永平.md",
    gender:"男", birth:1961, died:null, age:65, ageBracket:"65+",
    field:"投资与金融", income:"亿美元以上", incomeTier:5, region:"中国",
    bio:"步步高创始人、OPPO/vivo 幕后投资人、以天价午餐拍下巴菲特时间的价值投资者，'本分'哲学倡导者。",
    schools:["strategy","thinking"],
    viewpoints:[
      {t:"先做对的事，再把事做对", c:["C9","C15"], d:"方向正确是前提，方向错了执行力越强走得越远。", auth:"亲历", verify:"其公开演讲与访谈（大意）"},
      {t:"本分：回归本质不走捷径", c:["C16","C7"], d:"不占便宜、不投机取巧，守住底线是对本质的诚实。", auth:"亲历", verify:"其'本分'哲学（公开资料）"},
      {t:"Stop Doing List 优先", c:["C14","C9"], d:"知道不该做什么比该做什么更有价值。", auth:"亲历", verify:"其雪球与访谈（大意）"},
      {t:"能力圈边界意识", c:["C9","C16"], d:"真专家清楚自己不知道什么，承认边界是高质量判断的前提。", auth:"亲历", verify:"其投资理念（大意）"},
      {t:"长期主义与集中投入", c:["C2","C8"], d:"不需要很多机会，需要少数几次大的投入并长期坚持。", auth:"亲历", verify:"其'十年持有'原则（大意）"},
      {t:"简单优于复杂", c:["C6","C14"], d:"好商业模式是简单的，精通路径也不应过度复杂化。", auth:"亲历", verify:"其投资理念（大意）"},
      {t:"护城河意识", c:["C10","C9"], d:"核心竞争力要问持久性——可持续结构性积累才是护城河。", auth:"亲历", verify:"其投资理念（大意）"},
    ]
  },
  {
    id:"yujun", name:"Yu Jun", nameZh:"俞军",
    file:"experts/俞军.md",
    gender:"男", birth:1974, died:null, age:52, ageBracket:"50-64",
    field:"计算机与工程科技", income:"十万至百万美元级（30–100万美元）", incomeTier:2, region:"中国",
    bio:"中国产品经理体系奠基人，前百度产品副总裁，'产品经理是用户代言人'理念的提出者。",
    schools:["system","action"],
    viewpoints:[
      {t:"用户价值公式", c:["C6","C4"], d:"用户价值=新体验-旧体验-替换成本，把'好产品'变成可量化检验。", auth:"亲历", verify:"其产品方法论（公开资料）"},
      {t:"决策能力是核心", c:["C6","C9"], d:"专家本质是在信息不充分时做出相对最优决策的能力。", auth:"亲历", verify:"其《俞军产品方法论》"},
      {t:"自我学习占成长50%", c:["C11","C5"], d:"自我学习(50%)>实践反馈(30%)>外部指导(20%)。", auth:"亲历", verify:"其《俞军产品方法论》"},
      {t:"跨学科阅读构建底层框架", c:["C11","C12"], d:"心理学经济学社会学提供理解人与世界的底层框架。", auth:"亲历", verify:"其《俞军产品方法论》"},
      {t:"理性+同理心+直觉", c:["C12","C1"], d:"科学家理性、心理学家同理心、艺术家直觉三者融合方为精通。", auth:"亲历", verify:"其产品方法论（大意）"},
      {t:"用户是需求的集合", c:["C6","C13"], d:"穿透'人'的表象，理解对象（用户/市场/系统）的本质结构。", auth:"亲历", verify:"其产品方法论（大意）"},
      {t:"用户代言人定位", c:["C13","C16"], d:"身份认同决定决策方向——专家是'我代表谁的利益'。", auth:"亲历", verify:"其产品方法论（公开资料）"},
    ]
  },
  {
    id:"caizhizhong", name:"Cai Zhizhong", nameZh:"蔡志忠",
    file:"experts/蔡志忠.md",
    gender:"男", birth:1948, died:null, age:78, ageBracket:"65+",
    field:"艺术与设计", income:"十万至百万美元级（估算）", incomeTier:2, region:"中国",
    bio:"台湾漫画家，以禅意漫画化中国古典哲学闻名，'置心一处'与早立志的极端实践者。",
    schools:["practice","mindset"],
    viewpoints:[
      {t:"早立志锁定一生方向", c:["C9","C2"], d:"4岁半决定画漫画，方向一旦确定几十年如一日执行。", auth:"亲历", verify:"其自述（公开访谈）"},
      {t:"找到天赋所在", c:["C9","C13"], d:"找到最喜欢最拿手的事是前提，错误赛道越努力越偏离。", auth:"亲历", verify:"其演讲与访谈（大意）"},
      {t:"做到极致成为世界第一", c:["C10","C1"], d:"选择无竞争的独一赛道（古典哲学漫画化）天然成为第一。", auth:"亲历", verify:"其自述（公开访谈）"},
      {t:"置心一处极端时间投入", c:["C3","C1"], d:"连续数十小时伏案、凌晨即起，超长深度工作是精通必要条件。", auth:"亲历", verify:"其创作习惯自述"},
      {t:"化繁为简的精通标准", c:["C6","C16"], d:"深入理解复杂事物再以最简形式传达，深入后简出。", auth:"亲历", verify:"其创作理念（大意）"},
      {t:"跨域贯通助力极致", c:["C12","C11"], d:"研究物理数学佛学禅宗桥牌为'那一件事'提供认知基底。", auth:"亲历", verify:"其自述（公开访谈）"},
      {t:"热爱驱动而非意志力驱动", c:["C13","C15"], d:"数十年每日工作十几小时靠纯粹热爱，'坚持'不再是消耗。", auth:"亲历", verify:"其自述（公开访谈）"},
    ]
  },
  {
    id:"brucelee", name:"Bruce Lee", nameZh:"李小龙",
    file:"experts/李小龙.md",
    gender:"男", birth:1940, died:1973, age:33, ageBracket:"30-49",
    field:"体育·竞技与修行", income:"学者薪级（已故）", incomeTier:1, region:"中国",
    bio:"武术家、功夫电影巨星、截拳道创始人，'Be Water'哲学让武术与思想贯通。",
    schools:["practice","thinking","action"],
    viewpoints:[
      {t:"知行合一行动优先", c:["C16","C1"], d:"知道还不够必须运用，行动是把'懂'变成'会'的唯一通道。", auth:"亲历", verify:"其武术哲学（公开资料）"},
      {t:"一种腿法练一万次", c:["C1","C3"], d:"深度优于广度，超量重复把基本功刻入本能。", auth:"亲历", verify:"其名言（广为流传）"},
      {t:"像水一样", c:["C6","C12"], d:"Be Water：精熟形式后随机变形，专家不被固定方法锁死。", auth:"亲历", verify:"其访谈名言（广为流传）"},
      {t:"三阶段修炼曲线", c:["C7","C15"], d:"无知→形式束缚→回归自由，精通是否定之否定的螺旋。", auth:"亲历", verify:"其武术哲学论述"},
      {t:"做你自己不复制他人", c:["C10","C15"], d:"把普遍原理内化后长出独属于自己的表达。", auth:"亲历", verify:"其武术哲学（公开资料）"},
      {t:"以无法为有法", c:["C14","C6"], d:"截拳道不断做减法，去除多余至精纯，招式即原理。", auth:"亲历", verify:"其截拳道哲学"},
      {t:"身体即表达", c:["C1","C16"], d:"每日跑步数千次出拳的极端训练，原理必须成为本能。", auth:"亲历", verify:"其训练方式记载"},
      {t:"哲学根基武学贯通", c:["C6","C12"], d:"道家禅宗西方哲学贯通，理论基底决定技艺天花板。", auth:"亲历", verify:"其武学与哲学论述"},
    ]
  },
  {
    id:"renzhengfei", name:"Ren Zhengfei", nameZh:"任正非",
    file:"experts/任正非.md",
    gender:"男", birth:1944, died:null, age:82, ageBracket:"65+",
    field:"计算机与工程科技", income:"亿美元以上", incomeTier:5, region:"中国",
    bio:"华为创始人，以'以客户为中心''自我批判''灰度哲学'打造全球领先的ICT企业。",
    schools:["strategy","mindset"],
    viewpoints:[
      {t:"以客户为中心", c:["C13","C16"], d:"一切努力回到'为谁创造价值'，客户价值是检验标准。", auth:"亲历", verify:"华为核心价值观（公开资料）"},
      {t:"自我批判", c:["C16","C7"], d:"不断否定过去成功模式，防止组织僵化与路径依赖。", auth:"亲历", verify:"任正非内部讲话（公开报道）"},
      {t:"板凳要坐十年冷", c:["C2","C1"], d:"研发与专业突破需要长期无人喝彩的积累。", auth:"亲历", verify:"任正非内部讲话（广为流传）"},
      {t:"力出一孔", c:["C3","C14"], d:"把有限力量集中到一个点上才能穿透，拒绝多元化稀释。", auth:"亲历", verify:"任正非内部讲话（公开报道）"},
      {t:"灰度哲学", c:["C6","C9"], d:"容忍不完美，在黑白间找平衡，开放妥协管理复杂性。", auth:"亲历", verify:"任正非讲话（公开报道）"},
      {t:"一杯咖啡吸收宇宙能量", c:["C11","C12"], d:"开放学习一切先进经验，向包括对手在内的一切人学习。", auth:"亲历", verify:"任正非内部讲话（公开报道）"},
      {t:"方向大致正确组织充满活力", c:["C9","C8"], d:"完美战略不存在，大致正确即可；战略是方向活力是燃料。", auth:"亲历", verify:"任正非2017年前后讲话（公开报道）"},
    ]
  },
  {
    id:"mayun", name:"Jack Ma", nameZh:"马云",
    file:"experts/马云.md",
    gender:"男", birth:1964, died:null, age:62, ageBracket:"50-64",
    field:"计算机与工程科技", income:"亿美元以上", incomeTier:5, region:"中国",
    bio:"阿里巴巴创始人，'因为相信所以看见'的愿景驱动型创业者与商业思想家。",
    schools:["strategy","action"],
    viewpoints:[
      {t:"因为相信所以看见", c:["C13","C9"], d:"愿景不是对现状的预测而是对未来的选择，先相信再投入。", auth:"亲历", verify:"马云演讲（广为流传）"},
      {t:"今天很残酷明天更残酷", c:["C8","C7"], d:"多数人死在黎明之前，韧性是信念支撑下的持续行动。", auth:"亲历", verify:"马云演讲（广为流传）"},
      {t:"使命驱动", c:["C13","C16"], d:"让天下没有难做的生意：使命连接更大价值，提供意义感。", auth:"亲历", verify:"阿里巴巴使命（公开资料）"},
      {t:"拥抱变化", c:["C7","C12"], d:"把变化当常态与机会而非威胁，是适应复杂环境的策略。", auth:"亲历", verify:"阿里巴巴价值观（公开资料）"},
      {t:"102年的企业", c:["C2","C8"], d:"用代际尺度看问题，拒绝短期诱惑，决策质量完全不同。", auth:"亲历", verify:"马云关于长期主义的论述（公开报道）"},
      {t:"最大的敌人是自己", c:["C8","C7"], d:"失败多来自自我放弃与自我设限，对手是昨天的认知。", auth:"亲历", verify:"马云演讲（公开报道）"},
    ]
  },
  {
    id:"zhangyiming", name:"Zhang Yiming", nameZh:"张一鸣",
    file:"experts/张一鸣.md",
    gender:"男", birth:1983, died:null, age:43, ageBracket:"30-49",
    field:"计算机与工程科技", income:"亿美元以上", incomeTier:5, region:"中国",
    bio:"字节跳动创始人，'延迟满足感'与第一性原理思维的理性主义企业家代表。",
    schools:["thinking","mindset"],
    viewpoints:[
      {t:"延迟满足感", c:["C2","C8"], d:"克服人性弱点，为长期价值放弃短期快感以获得更多自由。", auth:"亲历", verify:"其演讲与微博（公开资料）"},
      {t:"平常心做非常事", c:["C7","C15"], d:"高压时刻剥离情绪干扰回归本质，决策不被焦虑绑架。", auth:"亲历", verify:"其2021年字节九周年演讲"},
      {t:"大力出奇迹", c:["C1","C3"], d:"方向正确前提下高强度投入，识别高杠杆点后饱和攻击。", auth:"亲历", verify:"其内部讲话（公开报道）"},
      {t:"第一性原理", c:["C6","C9"], d:"拆解到基本现实与用户需求再重新推导，不满足于行业惯例。", auth:"亲历", verify:"其思维方式论述（公开报道）"},
      {t:"信息效率决定一切", c:["C6","C11"], d:"高质量决策依赖高质量信息，信息效率是核心竞争力。", auth:"亲历", verify:"其关于信息分发的论述（公开报道）"},
      {t:"始终创业", c:["C15","C7"], d:"保持小公司的敏锐与第一天心态，拒绝官僚化与迟钝。", auth:"亲历", verify:"字节跳动企业文化（公开资料）"},
    ]
  },
  {
    id:"zhongnanshan", name:"Zhong Nanshan", nameZh:"钟南山",
    file:"experts/钟南山.md",
    gender:"男", birth:1936, died:null, age:90, ageBracket:"65+",
    field:"医学与自然科学", income:"学者薪级", incomeTier:1, region:"中国",
    bio:"中国工程院院士、呼吸病学专家，'说真话做实事'的公共医学象征。",
    schools:["system","practice"],
    viewpoints:[
      {t:"说真话做实事", c:["C16","C7"], d:"基于证据说话、敢于质疑权威结论，专业底色是诚实。", auth:"亲历", verify:"其公共言行（公开报道）"},
      {t:"医学是实践的科学", c:["C1","C4"], d:"必须在真实病人身上反复验证，脱离临床的研究是残缺的。", auth:"亲历", verify:"其临床医学论述（公开报道）"},
      {t:"顶天立地", c:["C1","C9"], d:"基础研究（顶天）与服务患者（立地）缺一不可。", auth:"亲历", verify:"其科研理念（公开报道）"},
      {t:"终身学习终身锻炼", c:["C2","C11"], d:"身体与头脑双复利：起步早不断档，晚年才有累积效应。", auth:"亲历", verify:"其生活习惯与访谈"},
      {t:"看病不是看机器是看病人", c:["C13","C16"], d:"技术之上还有对人的关怀，把对象当'人'而非'病例'。", auth:"亲历", verify:"其医学人文论述（公开报道）"},
      {t:"使命担当", c:["C13","C8"], d:"关键时刻专业能力与使命绑定，让专家在风险面前不退场。", auth:"亲历", verify:"其2003/2020年公共行为"},
    ]
  },
  {
    id:"yangzhenning", name:"Chen-Ning Yang", nameZh:"杨振宁",
    file:"experts/杨振宁.md",
    gender:"男", birth:1922, died:null, age:104, ageBracket:"65+",
    field:"医学与自然科学", income:"学者薪级", incomeTier:1, region:"中国",
    bio:"诺贝尔物理学奖得主，杨-米尔斯规范场论奠基人，华人科学家的旗帜。",
    schools:["thinking","practice"],
    viewpoints:[
      {t:"宁拙毋巧宁朴毋华", c:["C1","C15"], d:"治学最忌投机取巧与浮华，扎实基本功是一切大发现的地基。", auth:"亲历", verify:"其为清华学生题词（公开报道）"},
      {t:"选对方向是第一要素", c:["C9","C2"], d:"方向先于勤奋与机遇，方向错越勤奋越偏离。", auth:"亲历", verify:"其多次访谈（公开报道）"},
      {t:"直觉来自长期积累", c:["C2","C1"], d:"专家直觉是长期深入理解基本现象后的模式识别能力。", auth:"亲历", verify:"其科学方法论述（公开演讲）"},
      {t:"科学品味", c:["C6","C13"], d:"能'闻'出哪个问题重要，品味是比技巧更高阶的判断力。", auth:"亲历", verify:"其科学美学论述（公开演讲）"},
      {t:"对称性思维", c:["C6","C1"], d:"世界的规律隐藏在结构对称中，追问最深层结构约束。", auth:"亲历", verify:"其物理学方法论（公开资料）"},
      {t:"家国情怀", c:["C13","C9"], d:"专家对群体的价值在于为后来者打开可能性空间。", auth:"亲历", verify:"其公开表述（广为流传）"},
    ]
  },
  {
    id:"tuoyouyou", name:"Tu Youyou", nameZh:"屠呦呦",
    file:"experts/屠呦呦.md",
    gender:"女", birth:1930, died:null, age:96, ageBracket:"65+",
    field:"医学与自然科学", income:"学者薪级", incomeTier:1, region:"中国",
    bio:"药学家、诺贝尔生理学或医学奖得主，青蒿素发现者，'190多次失败终获成功'的坚持典范。",
    schools:["practice","system"],
    viewpoints:[
      {t:"坚持是成功的最后一块拼图", c:["C8","C2"], d:"方向正确时'再试一次'往往就是突破本身。", auth:"亲历", verify:"其青蒿素研究历程（公开资料）"},
      {t:"向经典学习", c:["C11","C12"], d:"从《肘后备急方》获低温提取灵感，古籍是思想矿藏。", auth:"亲历", verify:"其诺贝尔奖演讲与访谈"},
      {t:"集体成就观", c:["C5","C13"], d:"青蒿素是举国体制与团队协作的成果，专家成长于体系。", auth:"亲历", verify:"其诺贝尔奖演讲（2015）"},
      {t:"跨域类比", c:["C12","C1"], d:"古方经验与化学提取方法嫁接，创新在两知识体系交界处。", auth:"亲历", verify:"其研究方法（公开资料）"},
      {t:"耐得住寂寞", c:["C2","C15"], d:"科研反馈极慢（40余年），忍受无回报周期是分水岭。", auth:"亲历", verify:"其科研历程（公开资料）"},
      {t:"以身试药的科学勇气", c:["C7","C16"], d:"为验证青蒿素安全性亲身试药，信念与行动高度一致。", auth:"亲历", verify:"其研究历史记载（公开资料）"},
    ]
  },
  {
    id:"moyan", name:"Mo Yan", nameZh:"莫言",
    file:"experts/莫言.md",
    gender:"男", birth:1955, died:null, age:71, ageBracket:"65+",
    field:"思想写作与传播", income:"数百万至千万级", incomeTier:3, region:"中国",
    bio:"诺贝尔文学奖得主，'高密东北乡'的缔造者，魔幻现实主义与民间叙事的集大成者。",
    schools:["practice","action"],
    viewpoints:[
      {t:"诚实是文学的底线", c:["C16","C7"], d:"文学根本任务是揭示真相，回避真实的写作是对读者的欺骗。", auth:"亲历", verify:"其演讲与访谈（公开报道）"},
      {t:"扎根生活", c:["C11","C13"], d:"深度观察体验自己的生活土壤，特定性产生普遍性。", auth:"亲历", verify:"其'高密东北乡'创作观"},
      {t:"找到自己的声音", c:["C10","C15"], d:"模仿大师只能产生二流作品，不可替代是身份与视角问题。", auth:"亲历", verify:"其文学个性论述（公开报道）"},
      {t:"写作是长期艰苦劳动", c:["C2","C1"], d:"灵感只是劳动过程中的偶然馈赠，写作没有捷径。", auth:"亲历", verify:"其关于写作的论述（公开报道）"},
      {t:"讲故事的人", c:["C16","C13"], d:"叙事将经验外化、记忆保存、价值传递，外化是影响力载体。", auth:"亲历", verify:"其诺贝尔奖演讲《讲故事的人》（2012）"},
      {t:"想象力与生活经验双引擎", c:["C12","C7"], d:"无经验的想象是空转，无想象的经历是流水账，二者结合。", auth:"亲历", verify:"其创作方法论（公开报道）"},
    ]
  },
  {
    id:"lian", name:"Ang Lee", nameZh:"李安",
    file:"experts/李安.md",
    gender:"男", birth:1954, died:null, age:72, ageBracket:"65+",
    field:"艺术与设计", income:"数百万至千万级", incomeTier:3, region:"中国",
    bio:"两获奥斯卡最佳导演的华人导演，'永远当学生'与'电影是一场修行'的作者型创作者。",
    schools:["action","practice"],
    viewpoints:[
      {t:"永远当学生", c:["C11","C7"], d:"成就不是毕业证书而是下一部作品，保持初学者心态学新工具。", auth:"亲历", verify:"其多次采访（公开报道）"},
      {t:"恐惧即燃料", c:["C7","C13"], d:"每部电影都害怕，但让恐惧驱动准备与精进而非瘫痪行动。", auth:"亲历", verify:"其采访（公开报道）"},
      {t:"压力下发挥", c:["C7","C1"], d:"把压力当舞台而非威胁，充分准备将其转化为专注。", auth:"亲历", verify:"其关于创作与压力的论述（公开报道）"},
      {t:"真诚第一", c:["C16","C15"], d:"技巧可学，作品最终呈现创作者的真心，不真诚技巧越高越空。", auth:"亲历", verify:"其创作论述（公开报道）"},
      {t:"修行式坚持", c:["C15","C8"], d:"每部作品都是修行的片段，没有'完成'的状态。", auth:"亲历", verify:"其采访（公开报道）"},
      {t:"作者性", c:["C10","C15"], d:"高度工业化行业里，个人印记（题材视角节奏）是最大护城河。", auth:"亲历", verify:"其创作理念（公开报道）"},
    ]
  },
  {
    id:"yaoming", name:"Yao Ming", nameZh:"姚明",
    file:"experts/姚明.md",
    gender:"男", birth:1980, died:null, age:46, ageBracket:"30-49",
    field:"体育·竞技与修行", income:"数百万至千万级", incomeTier:3, region:"中国",
    bio:"前NBA全明星中锋、中国篮协主席，'天赋决定上限努力决定下限'的实践者。",
    schools:["practice","mindset"],
    viewpoints:[
      {t:"天赋决定上限努力决定下限", c:["C2","C1"], d:"天赋定天花板，努力定实际到达高度，多数人问题不是天赋。", auth:"亲历", verify:"其多次采访（广为流传）"},
      {t:"科学化训练改造", c:["C1","C5"], d:"NBA前的身体改造把身高优势转化为赛场能力，天赋需被激活。", auth:"亲历", verify:"其赴美训练经历（公开报道）"},
      {t:"团队优先", c:["C5","C16"], d:"篮球是五个人的运动，个人精通需嵌入团队系统。", auth:"亲历", verify:"其多次采访（公开报道）"},
      {t:"压力即成长", c:["C7","C8"], d:"扛下全国期待转化为训练动力，扛下来就是成长。", auth:"亲历", verify:"其国家队经历自述"},
      {t:"身份认同", c:["C15","C13"], d:"'我属于篮球'：身份认同让训练不再是苦役而是自我实现。", auth:"亲历", verify:"其身份认同表述（公开报道）"},
      {t:"体系大于天才", c:["C17","C5"], d:"青训、联赛、教练体系决定天才涌现，个体无法替代系统。", auth:"亲历", verify:"其篮协改革论述（公开报道）"},
    ]
  },
];

// ---- 国别维度：出生国 → 主要执业国（countryBirth / countryWork）----
const COUNTRY = {
  // 非中国专家（43 位）
  ericsson:["瑞典","美国"], gladwell:["英国","美国"], duckworth:["美国","美国"], dweck:["美国","美国"],
  newport:["美国","美国"], waitzkin:["美国","美国"], leonard:["美国","美国"], epstein:["美国","美国"],
  gawande:["美国","美国"], godin:["美国","美国"], brown:["美国","美国"], angelou:["美国","美国"],
  munger:["美国","美国"], musk:["南非","美国"], feynman:["美国","美国"], naval:["印度","美国"],
  csikszentmihalyi:["匈牙利","美国"], kahneman:["以色列","美国"], coyle:["美国","美国"], konnikova:["俄罗斯","美国"],
  kasparov:["苏联","俄罗斯"], kobe:["美国","美国"], serena:["美国","美国"], federer:["瑞士","瑞士"],
  goodall:["英国","英国"], rams:["德国","德国"], adria:["西班牙","西班牙"], torvalds:["芬兰","美国"],
  greene:["美国","美国"], ferriss:["美国","美国"], tharp:["美国","美国"], stanislavski:["俄罗斯","俄罗斯"],
  gould:["加拿大","加拿大"], king:["美国","美国"], pressfield:["美国","美国"], clear:["美国","美国"],
  mcclintock:["美国","美国"], wilson:["美国","美国"], buffett:["美国","美国"], musashi:["日本","日本"],
  aurelius:["罗马","罗马"], goggins:["美国","美国"], biles:["美国","美国"],
  // 中国专家（15 位）
  xiaolai:["中国","中国"], wujun:["中国","美国"], duanyongping:["中国","美国"], yujun:["中国","中国"],
  caizhizhong:["中国","中国"], brucelee:["美国","中国"], renzhengfei:["中国","中国"], mayun:["中国","中国"],
  zhangyiming:["中国","中国"], zhongnanshan:["中国","中国"], yangzhenning:["中国","美国"], tuoyouyou:["中国","中国"],
  moyan:["中国","中国"], lian:["中国","美国"], yaoming:["中国","中国"],
};
EXPERTS.forEach(e => { const c = COUNTRY[e.id]; e.countryBirth = c[0]; e.countryWork = c[1]; });
...
const DOMAIN = {
  ...
  // 中国专家（15 位）
  xiaolai:     {tier:"低效度", cluster:"投资预测"},
  wujun:       {tier:"低效度", cluster:"写作传播"},
  duanyongping:{tier:"低效度", cluster:"投资预测"},
  yujun:       {tier:"中效度", cluster:"创业工程"},
  caizhizhong: {tier:"高效度", cluster:"工艺创造"},
  brucelee:    {tier:"高效度", cluster:"竞技与认知竞技"},
  renzhengfei: {tier:"中效度", cluster:"创业工程"},
  mayun:       {tier:"中效度", cluster:"创业工程"},
  zhangyiming: {tier:"中效度", cluster:"创业工程"},
  zhongnanshan:{tier:"中效度", cluster:"医学诊断"},
  yangzhenning:{tier:"低效度", cluster:"科研探索"},
  tuoyouyou:   {tier:"低效度", cluster:"科研探索"},
  moyan:       {tier:"低效度", cluster:"写作传播"},
  lian:        {tier:"中效度", cluster:"表演艺术"},
  yaoming:     {tier:"高效度", cluster:"竞技与认知竞技"},
};
// 簇的展示顺序（按效度档分组）
const CLUSTER_ORDER = [
  "竞技与认知竞技","工艺创造",                          // 高效度
